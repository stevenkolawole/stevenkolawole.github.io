const NEWS_ITEMS = [
  `<strong>[Jul 2026]</strong> We're organizing, with support from Intron and Adaption Labs, an <a href="https://ml-collective-africa.github.io/dl-indaba-2026/workshop-challenge" target="_blank">Agentic Voice AI Challenge</a> at our <a href="https://ml-collective-africa.github.io/dl-indaba-2026/" target="_blank">Deep Learning Indaba workshop</a>: voice agents that handle code-switched, multilingual speech across health, fintech, agriculture, legal aid, and other domains where it matters.`,
